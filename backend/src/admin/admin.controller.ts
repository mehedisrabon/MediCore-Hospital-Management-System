...
import { CreatePatientDto } from "../receptionist/dto/create-patient.dto";
...
export class AdminController {
    ...
    @Post('patients')
    createPatient(@Body() data: CreatePatientDto): object {
    ...
    updatePatient(@Param('id') id: number, @Body() data: CreatePatientDto): object {
    ...
    // Update doctor, patient, and manager by id
    @Patch('patients/:id')
    updatePatients(@Param('id') id: number, @Body() data: CreatePatientDto):object {
